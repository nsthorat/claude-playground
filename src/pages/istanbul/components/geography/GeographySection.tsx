...
import { Map, Clock, Layers, Ship, Tag, Navigation } from 'lucide-react'
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative">
        ...
        {/* Layer Toggles - Top Left (only in explore/time mode) */}
        {mode !== 'here' && (
      ...
      {/* Two Continents Note (not in Here mode) */}
      {mode !== 'here' && (
