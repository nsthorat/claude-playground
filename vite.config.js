  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        'sensory-warehouse': resolve(__dirname, 'sensory-experiences/warehouse/index.html'),
        'sensory-rain-on-glass': resolve(__dirname, 'sensory-experiences/rain-on-glass/index.html'),
        'sensory-drone-cathedral': resolve(__dirname, 'sensory-experiences/drone-cathedral/index.html'),
        'sensory-golden-hour': resolve(__dirname, 'sensory-experiences/golden-hour/index.html'),
      },
    },
  },
  resolve: {
